...
public class HouseNeed {
    ...
    public HouseNeed(Integer id, String title, String content, BigDecimal price, String province, String city, String town, BigDecimal area, Integer author, String tips, Integer flag) {
        this.id = id;
        this.title = title;
    ...
    public HouseNeed(HouseNeedDto dto){
        this.id=dto.getId();
